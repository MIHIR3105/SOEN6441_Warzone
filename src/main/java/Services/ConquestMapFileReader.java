...
public class ConquestMapFileReader implements Serializable {
    /**
     * Method to read conquest map file, parses it and stores it in map.
     *
    ...
    /**
     * Method to return the corresponding map file lines.
     *
        ...
        switch (p_switchParameter) {
            case "continent":
                List<String> l_continentLines = p_fileLines.subList(
                        p_fileLines.indexOf(GameConstants.CONQUEST_CONTINENTS) + 1,
                        p_fileLines.indexOf(GameConstants.CONQUEST_TERRITORIES) - 1);
                return l_continentLines;
            case "country":
                List<String> l_countryLines = p_fileLines
                        .subList(p_fileLines.indexOf(GameConstants.CONQUEST_TERRITORIES) + 1, p_fileLines.size());
    ...
    /**
     * Method to parse extracted country and border data of
     * map file.
     *
    ...
    /**
     * Method to filter continent based on continent name.
     *
    ...
    /**
     * Method to filter country based on country name.
     *
