...
public class MapService implements Serializable {
    ...
    /**
     * Method to load and read map file.
     *
    ...
    /**
     * Method to create a new map if map to be edited does not
     * exists, and if it exists it parses the map file to
     * game state object.
     *
    ...
    /**
     * Method to control the Flow of Edit Operations: editcontinent, editcountry, editneighbor.
     *
    ...
    /**
     * Method that constructs updated Continents list based on passed operations - Add/Remove
     * and Arguments.
     *
     * @param p_gameState      Current GameState Object
            ...
            if (!p_fileName.equalsIgnoreCase(p_gameState.getD_map().getD_mapFile())) {
                ...
                if (null != p_gameState.getD_map()) {
                    ...
                    if (l_currentMap.Validate()) {
                        ...
                        extractMapToFile(p_gameState, l_writer, l_mapFormat);
    ...
    /**
     * Method to parses the Map Object to File.
     *
     * @param p_gameState current gamestate
     ...
     * @throws IOException Exception
     */
    private void extractMapToFile(GameState p_gameState, FileWriter l_writer, String l_mapFormat) throws IOException {
    ...
    /**
     * Method to reset the Game State's Map.
     *
    ...
    /**
     * Method to check in what format user wants to save the map file.
     *
